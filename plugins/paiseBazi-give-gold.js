...
*${usedPrefix + command}*  rupees [amount] [@user]

📌 Example : 
*${usedPrefix + command}* rupees 1000 @${m.sender.split('@')[0]}
`.trim()
...
handler.help = ['give'].map(v => v + ' rupees [amount] [@tag]')
