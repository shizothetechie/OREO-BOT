...
let handler = async (m, { oreo, usedPrefix, command }) => {
  oreo.cartoon = oreo.cartoon ? oreo.cartoon : {}
  if (m.sender in oreo.cartoon)
  ...
  else oreo.cartoon[m.sender] = true
  ...
  try {
    Cartoon(img).then(async response => {
      if (response.message == 'success') {
        ...
        oreo.sendMessage(m.chat, await sticker.toMessage(), { quoted: m })
      } else {
        m.reply(
    ...
    oreo.cartoon[m.sender] ? delete oreo.cartoon[m.sender] : false
  }
}
