...
import { canLevelUp, xpRange } from '../oreolab/levelling.js'

let handler = async (m, { oreo, args, usedPrefix, participants }) => {
  ...
  let about = (await oreo.fetchStatus(who).catch(console.error))?.status || ''
