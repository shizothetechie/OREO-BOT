let handler = async (m, { oreo, args, text, usedPrefix, command }) => {
  ...
  switch (type) {
    case 'gfx1':
      ...
      oreo.sendFile(m.chat, chut, 'logo.png', `✅ Result`, m)
      m.react(done)
      break
    ...
    case 'gfx2':
      ...
      oreo.sendFile(m.chat, loda, 'logo.png', `✅ Result`, m)
    ...
    case 'gfx3':
      ...
      oreo.sendFile(m.chat, cp, 'logo.png', `✅ Result`, m)
      m.react(done)
      break
    ...
    case 'gfx6':
      ...
      oreo.sendFile(m.chat, apiUrl, 'logo.png', `✅ Result`, m)
      m.react(done)
      break
    case 'gfx7':
      if (!text) throw too
      ...
      oreo.sendFile(m.chat, oda, 'logo.png', `✅ Result`, m)
    ...
    case 'gfx11':
      ...
      oreo.sendFile(m.chat, od, 'logo.png', `✅ Result`, m)
    ...
    case 'gfx12':
      ...
      oreo.sendFile(m.chat, rr, 'logo.png', `✅ Result`, m)
      m.react(done)
      break
