		...
		case "enhance":
			{
				...
				try {
					...
					oreo.sendFile(m.chat, This, "shizo.img", maker, m);
				} catch (er) {
					error = true;
				} finally {
					if (error) {
						m.reply("Disoreoected from server");
					}
